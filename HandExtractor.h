...
class HandExtractor
	...
	/* Elements: */
	private:
	Size depthFrameSize; // Size of incoming depth frames
	...
	public:
	HandExtractor(const Size& sDepthFrameSize,const PixelDepthCorrection* sPixelDepthCorrection,const PTransform& sDepthProjection); // Creates a hand extractor for depth frames of the given size
	private:
