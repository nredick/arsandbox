...
HandExtractor::HandExtractor(const Size& sDepthFrameSize,const HandExtractor::PixelDepthCorrection* sPixelDepthCorrection,const PTransform& sDepthProjection)
	:depthFrameSize(sDepthFrameSize),
