...
class DEM:public GLObject
	...
	/* Elements: */
	private:
	Size demSize; // Width and height of the DEM grid
	...
	void uploadDemTransform(Shader& shader) const; // Uploads the DEM transformation into the GLSL 4x4 matrix at the given uniform index in the given shader
	GLint bindTexture(GLContextData& contextData,TextureTracker& textureTracker) const; // Binds the DEM texture object to the given texture unit and the uniform variable of the given index in the given shader
	};
